...
- Completed headquarters replace lost builders and produce dedicated faction-named supply carriers. Builders and carriers physically enter captured zones, gather cargo, return it to the nearest warehouse or headquarters, and can flee when hostile proximity makes a haul unsafe.
