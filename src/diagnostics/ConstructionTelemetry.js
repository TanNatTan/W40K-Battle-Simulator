const STAGES = Object.freeze(["selected", "planned", "funding-wait", "dependency-wait", "site-wait", "builder-travel", "construction", "completed", "cancelled", "training-wait", "force-cap-wait", "manifest-resource-wait", "deployed"]);
