...
test("PDF doctrine registry covers eight races, sixteen cadence profiles, and twenty-eight scoped subfactions", () => {
  ...
  assert.equal(Object.values(doctrines.subfactions).reduce((sum, entries) => sum + Object.keys(entries).length, 0), 28);
