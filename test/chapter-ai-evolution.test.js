...
function passingMetrics(chapter) {
  ...
  return {
    ...
    formationAccuracy: 0.9,
    commanderPresence: 1,
    troopsOutsideHeadquarters: 0.85,
    formationStuckRatio: 0.005,
    transportOpportunities: 2,
    transportUtilization: 0.8,
    frontlineDistant: true,
    forwardOutposts: 1,
    deploymentAccuracy: 0.9,
    tacticalInnovation: 0.7,
